  ...
  return (
    <div className="px-4">
      <form>
        ...
        <div className=" flex flex-col lg:flex-row lg:justify-around gap-4 md:gap-0">
          
          {/* Año */}
          <div className="flex flex-col md:flex-row items-start md:items-center mb-3">
            <h1 className="p-2 md:pr-5">Año:</h1>
            <select className="bg-gray-200 rounded p-2 w-full md:w-[100%]  ml-[50px]">
          ...
          <div className="flex flex-col  md:flex-row items-start md:items-center">
            <h1 className="p-2 md:pr-5">Resultados:</h1>
            <select
              onChange={(e) => setProvincia(e.target.value)}
              className="bg-gray-200 rounded p-2 w-full md:w-[100%]"
            >
          ...
          {/* Tipo de elección */}
          <div className="flex flex-col  md:flex-row items-start md:items-center">
            <h1 className="p-2 md:pr-5">Tipo Elección:</h1>
            <select
